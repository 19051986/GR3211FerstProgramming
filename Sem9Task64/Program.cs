// #64 Задайте значение N. Напишите программу, которая 
...
string SequenceRevers(uint num)
{
    if (num == 0) return string.Empty;
    return $"{num} {SequenceRevers(num - 1)}";
}

PrintData(SequenceRevers(ReadData("Введите число: ")));